            ...
            >
                <div className="bg-indigo-600 dark:bg-cyber-accent/10 p-6 text-white dark:text-cyber-accent text-center relative border-b dark:border-cyber-border">
                    ...
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-white/20 dark:bg-cyber-accent/20 rounded-full mb-4 shadow-inner">
                        <Plus className="size-10 text-white dark:text-cyber-accent" />
                    </div>
                    <h2 className="text-xl font-bold dark:text-white">{title}</h2>
                    <p className="text-indigo-100 dark:text-slate-400 text-sm mt-1">{subtitle}</p>
                </div>
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <Folder className="size-5 text-gray-400 dark:text-slate-500" />
                                </div>
                                <TextInput
                                    id="folder-name"
                                    type="text"
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="px-4 py-2.5 text-sm font-bold text-white bg-indigo-600 dark:bg-cyber-accent hover:bg-indigo-700 dark:hover:bg-cyan-400 rounded-xl transition-all shadow-lg shadow-indigo-100 dark:shadow-cyber-accent/20 disabled:opacity-50"
                            >
